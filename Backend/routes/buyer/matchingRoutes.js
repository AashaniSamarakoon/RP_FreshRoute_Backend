...
// GET /api/buyer/matching/order/:orderId - Get all proposals for a specific order
router.get("/order/:orderId", getProposalsForOrder);

// GET /api/buyer/matching/user/:userId - Get all proposals for a specific buyer
router.get("/buyer/:buyerId", getProposalsByBuyerId);

// GET /api/buyer/matching/farmer/:farmerId - Get all proposals for a specific farmer
